...
// source: ../../../3rdparty/pjproject/pjsip-apps/src/swig/pjsua2.i
...
class SwigDirector_AudioMediaPort : public pj::AudioMediaPort
{
 public:
  SwigDirector_AudioMediaPort(int swig_p);
  virtual ~SwigDirector_AudioMediaPort();
  void _swig_upcall_onFrameRequested(pj::MediaFrame &frame) {
    pj::AudioMediaPort::onFrameRequested(frame);
  }
  virtual void onFrameRequested(pj::MediaFrame &frame);
  void _swig_upcall_onFrameReceived(pj::MediaFrame &frame) {
...
class SwigDirector_Account : public pj::Account
{
 public:
  ...
  void _swig_upcall_onSendRequest(pj::OnSendRequestParam &prm) {
...
class SwigDirector_Endpoint : public pj::Endpoint
{
 public:
  ...
  pj_status_t _swig_upcall_onCredAuth(pj::OnCredAuthParam &prm) {
    return pj::Endpoint::onCredAuth(prm);
  }
  virtual pj_status_t onCredAuth(pj::OnCredAuthParam &prm);
  void _swig_upcall_onRejectedIncomingCall(pj::OnRejectedIncomingCallParam &prm) {
